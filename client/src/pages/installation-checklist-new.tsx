...
export default function InstallationChecklistNew() {
  ...
  // Debug: verificar dados da loja no localStorage
  console.log('📍 [DEBUG] Dados da loja do localStorage:', store);
  console.log('📍 [DEBUG] Logradouro:', store?.logradouro);
  console.log('📍 [DEBUG] Numero:', store?.numero);
  console.log('📍 [DEBUG] Bairro:', store?.bairro);
